...
RUN \
 ...
 apt-get update && apt-get install -y --allow-unauthenticated --no-install-recommends locales openssl openssh-server php php-curl php-apcu php-mbstring php-imagick php-bcmath php-xdebug php-soap pbzip2 ghostscript \
